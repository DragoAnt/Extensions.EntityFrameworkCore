...
using DragoAnt.Extensions.EntityConventions.Contacts.TriggerBased;
using DragoAnt.Extensions.EntityFrameworkCore.Relational;

namespace DragoAnt.Extensions.EntityFrameworkCore.EntityConventions.TriggerBased;
...
public static class ModelBuilderTriggerBasedConventionsExtensions
{
        ...
        where TConvention : IEntityConventionContract
    {
        ...
        {
            triggerNames = [typeof(TConvention).Name];
        }
